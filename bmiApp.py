...
st.write("กรอกข้อมูลน้ำหนักและส่วนสูงของคุณ ดพื่อเช็กสุขภาพเบื้องต้น")
